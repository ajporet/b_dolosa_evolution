...
ba = bar(stacked_bar_data([1,2,3,4,6,5,7,8],:),'stacked','FaceColor','flat','LineWidth',1,'EdgeColor','k');
ba(1).CData = yes_LPS_color;
ba(2).CData = [1,1,1];
hold on

errorbar([1,2,3,4,6,5,8],[no_LPS_num_by_time_percentage]',errorbar_1,errorbar_2,'.k','LineWidth',1.5,'CapSize',0)
