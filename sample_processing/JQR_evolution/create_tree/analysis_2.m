...
fprintf(fid,'\n');
fclose(fid);
temp_SCRIPTSDIRECTORY = '~/Dropbox\ \(MIT\)/Lieberman\ Lab/scripts'
eval_cmd = strjoin(['! python2.7 '  temp_SCRIPTSDIRECTORY '/countMutationsP.py ../' treefilename ' for_tree_labeling.csv'],"")
%eval(['! python2.7 '  SCRIPTSDIRECTORY '/countMutationsP.py ../' treefilename ' for_tree_labeling.csv'])
eval(eval_cmd)
cd('..')